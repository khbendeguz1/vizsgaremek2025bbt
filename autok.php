...
$sql = "SELECT * FROM cars WHERE berelve='0'";
if ($search) {
    $sql .= " AND marka LIKE '%$search%'";
}
...
$felhasznalonev = isset($_SESSION['felhasznalonev']) ? $_SESSION['felhasznalonev'] : '';
?>
...
<body>
    ...
    <div class="container mt-4">
        <h2 class="mb-3">Autók listája</h2>
...
<tbody>
    ...
    <p class="autoinfo"><strong>Ár: </strong><?= number_format($row['ar'], 0, '.', ' ') ?> Ft/nap</p> 
                    ...
                    <div class="modal-footer">
                        ...
                        <td><button class="btn btn-primary" onclick="location.href='login.php?auto_id=<?= $row['id'] ?>'">Bérlés</button></td>
                        </div>
