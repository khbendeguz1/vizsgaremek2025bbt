...
$sql = "SELECT * FROM cars WHERE kategoria = '1' AND berelve='0'";
if ($search) {
    $sql .= " AND marka LIKE '%$search%' and kategoria = '1'";
}
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="berles.php?auto_id=<?= $row['id'] ?>" class="btn btn-primary">Bérlés</a>
                    </div>
                </div>
            </div>
        </div>
